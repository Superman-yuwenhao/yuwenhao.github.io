...
<body>
  <table border="1"  cellpadding="3" cellspacing="3" align="center" bgcolor="#33333">
    ...
    <tr>
      <td colspan="4"><strong>技术掌握</strong>,</br>语言：熟练掌握java语言前端：了解html5、javaScript、jQuery、Ajax前端技术,熟练使用：Eclipse工具、SVN工具、TeamViewer工具,数据库相关：熟练掌握Mysql、Oracle,熟练使用Tomcat进行Web应用的开发,操作系统：掌握windows,系统命令：Linux基础命令,后台框架技术：熟练掌握SSM,前台框架技术：熟练掌握vue.js</td>
    </tr>
    <tr>
